...
public class SPIStatement implements Statement
	...
	throws SQLException
	{
		return this.executePlan(ExecutionPlan.prepare(statement, null));
	}
	...
	throws SQLException
	{
		...
		return false;	/* Indicate result as update count */
	}
	...
	throws SQLException
	{
		throw new UnsupportedFeatureException("Statement.executeUpdate(String,int)");
	}
	...
	throws SQLException
	{
		throw new UnsupportedFeatureException("Statement.executeUpdate(String,String[])");
	}
